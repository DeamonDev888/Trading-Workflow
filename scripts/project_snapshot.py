...
class ProjectSnapshot:
    ...
    def create_context_file(self, contexte_dir):
        ...
        context_lines.append("")
        context_lines.append("## Documentation Agents")
        context_lines.append("- docs/agents/README.md - Vue d'ensemble et architecture")
        context_lines.append("- docs/agents/index.md - Index des agents")
        context_lines.append("- docs/agents/risk-agent.md - Risk Agent")
        context_lines.append("- docs/agents/strategy-agent.md - Strategy Agent")
        context_lines.append("- docs/agents/funding-agent.md - Funding Agent")
        context_lines.append("- docs/agents/sentiment-agent.md - Sentiment Agent")
        context_lines.append("")
