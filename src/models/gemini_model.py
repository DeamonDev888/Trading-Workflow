"""Deamon Dev's Gemini Model Implementation
...
class GeminiModel(BaseModel):
    ...
    def initialize_client(self, **kwargs) -> None:
        ...
        try:
            ...
            safe_cprint(f"✨ Initialized Gemini model: {self.model_name}", "green")
        except Exception as e:
            safe_cprint(f"❌ Failed to initialize Gemini model: {str(e)}", "red")
            self.client = None
    ...
    def generate_response(
        ...
        **kwargs,
        ...
        try:
            ...
            if not response.candidates or not response.candidates[0].content.parts:
                ...
                if hasattr(response, "prompt_feedback"):
                    ...
                    block_reason = block_reason_map.get(
                        block_reason_value, f"UNKNOWN({block_reason_value})"
                    )
            ...
            safe_cprint(f"❌ Gemini generation error: {str(e)}", "red")
            raise
