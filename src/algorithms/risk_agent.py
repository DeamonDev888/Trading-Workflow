...
class RiskAgent:
    ...
    async def update_performance_metrics(self, trade_result: Dict):
        ...
        try:
            ...
            self.logger.info(
                f"Performance mise à jour: PnL total=${self.performance_metrics['total_pnl']}, Trades={self.performance_metrics['total_trades']}"
            )
            ...
            if command == "--get-dashboard-metrics":
                ...
                try:
                    ...
                    metrics_data = {
                        ...
                        "win_rate": agent.performance_metrics["winning_trades"]
                        / max(1, agent.performance_metrics["total_trades"]),
                        ...
                        "risk_level": (
                            ...
                            else "MEDIUM" if risk_metrics.leverage_ratio < 7 else "HIGH"
                        ),
                        "portfolio_beta": 1.2,
