...
class PersistentRiskAgent:
    """Persistent risk agent with Claude Code CLI integration"""
    ...
    def __init__(self, port: int, agent_id: str):
        ...
        # Initialize FastAPI
        self.app = FastAPI(title=f"Persistent Risk Agent")
...
if __name__ == "__main__":
    ...
    agent = PersistentRiskAgent(args.port, args.agent_id)
