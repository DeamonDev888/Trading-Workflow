...
Le système NOVAQUOTE Trading System intègre **4 agents IA distincts** qui fonctionnent de manière coordonnée pour gérer le trading automatisé sur HyperLiquid. Chaque agent a un rôle spécialisé et utilise **Claude Code Sub-Agents** pour prendre des décisions intelligentes.
...
- **Agent** = Script Python qui utilise Claude Code CLI avec sub-agents spécialisés
...
**Fonction :** Gestion du risque en temps réel, surveillance des positions, stop-loss automatiques
...
**Fonction :** Analyse technique, génération de signaux de trading, optimisation des stratégies
...
**Fonction :** Détection d'opportunités de funding arbitrage, optimisation des taux
...
**Fonction :** Analyse de sentiment du marché, détection de fear & greed, news impact
