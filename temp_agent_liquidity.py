...
class PersistentLiquidityAgent:
    """Persistent liquidity agent with Claude Code CLI integration"""
    ...
    def __init__(self, port: int, agent_id: str):
        ...
        # Initialize FastAPI
        self.app = FastAPI(title=f"Persistent Liquidity Agent")
...
if __name__ == "__main__":
    ...
    agent = PersistentLiquidityAgent(args.port, args.agent_id)
